...
const ParallaxSection: React.FC = () => {
  ...
  return (
    <section className={styles.sectionThird} ref={sectionRef}>
      {/* Section 2 content goes here */}

      <div className={styles.sectionThirdFlex}>
        <img className={styles.sectionThirdImage} src={sectionThirdImage} alt="" />
        <div className={styles.sectionThirdContent}>
          <h3>Objetivo</h3>
          <h2>Promovendo Saúde</h2>
          <p>
O alongamento diário é essencial para ciclistas, motociclistas, cadeirantes e motoboys, pois melhora a flexibilidade, previne lesões e aumenta o desempenho. De acordo com estudos científicos, como o da revista Journal of Sports Sciences, o alongamento regular melhora a eficiência muscular e reduz o risco de lesões musculoesqueléticas.</p>
...
const MainPage: React.FC = () => {
  const videoRef = useRef<HTMLVideoElement>(null); // Use a separate ref for the video element
  // const phoneRef = useRef<LottieRefCurrentProps | null>(null);
